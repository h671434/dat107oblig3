...
/**
 * Closes the previous running instance of the program on startup.
 * Used during development, because I forget the program during testing.
...
public class ServerReplacer extends Thread {
    ...
    private static void logOtherInstanceFound(boolean otherInstanceFound) {
    	 System.out.println(otherInstanceFound ? 
